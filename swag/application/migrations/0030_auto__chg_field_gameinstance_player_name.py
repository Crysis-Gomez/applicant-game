...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'GameInstance.player_name'
        db.alter_column(u'application_gameinstance', 'player_name', self.gf('django.db.models.fields.CharField')(default='Jerry', max_length=50))
    ...
    models = {
        ...
        u'application.gameinstance': {
            ...
            'player_name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True'}),
