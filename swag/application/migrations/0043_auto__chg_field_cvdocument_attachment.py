...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CvDocument.attachment'
        db.alter_column(u'application_cvdocument', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        u'application.cvdocument': {
            ...
            'attachment': ('django.db.models.fields.files.FileField', [], {'max_length': '20000'}),
