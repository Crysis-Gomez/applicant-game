...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vacancy.mail_text'
        db.delete_column(u'application_vacancy', 'mail_text')

        # Deleting field 'Vacancy.mail_text2'
        db.delete_column(u'application_vacancy', 'mail_text2')

        # Adding field 'Vacancy.introduction_mail'
        db.add_column(u'application_vacancy', 'introduction_mail',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 7, 19, 0, 0), max_length=500),
                      keep_default=False)

        # Adding field 'Vacancy.finalization_mail'
        db.add_column(u'application_vacancy', 'finalization_mail',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 7, 19, 0, 0), max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Vacancy.mail_text'
        db.add_column(u'application_vacancy', 'mail_text',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 7, 19, 0, 0), max_length=500),
                      keep_default=False)

        # Adding field 'Vacancy.mail_text2'
        db.add_column(u'application_vacancy', 'mail_text2',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 7, 19, 0, 0), max_length=500),
                      keep_default=False)

        # Deleting field 'Vacancy.introduction_mail'
        db.delete_column(u'application_vacancy', 'introduction_mail')

        # Deleting field 'Vacancy.finalization_mail'
        db.delete_column(u'application_vacancy', 'finalization_mail')
