...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameInstance.cv_game_time'
        db.add_column(u'application_gameinstance', 'cv_game_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameInstance.cv_game_time'
        db.delete_column(u'application_gameinstance', 'cv_game_time')
    ...
    models = {
        ...
        u'application.gameinstance': {
            ...
            'cv_game_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
