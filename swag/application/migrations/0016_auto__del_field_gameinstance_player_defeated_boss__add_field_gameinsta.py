...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GameInstance.player_defeated_boss'
        db.delete_column(u'application_gameinstance', 'player_defeated_boss')

        # Adding field 'GameInstance.player_unlocked_boss'
        db.add_column(u'application_gameinstance', 'player_unlocked_boss',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GameInstance.player_defeated_boss'
        db.add_column(u'application_gameinstance', 'player_defeated_boss',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'GameInstance.player_unlocked_boss'
        db.delete_column(u'application_gameinstance', 'player_unlocked_boss')
