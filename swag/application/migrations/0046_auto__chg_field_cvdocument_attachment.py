...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'application_cvdocument', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=42000000))
    ...
    models = {
        u'application.cvdocument': {
            ...
            'attachment': ('django.db.models.fields.files.FileField', [], {'max_length': '42000000'}),
