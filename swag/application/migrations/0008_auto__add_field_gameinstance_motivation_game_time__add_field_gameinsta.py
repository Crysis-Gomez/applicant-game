...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameInstance.motivation_game_time'
        db.add_column(u'application_gameinstance', 'motivation_game_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GameInstance.skill_game_time'
        db.add_column(u'application_gameinstance', 'skill_game_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GameInstance.links_game_time'
        db.add_column(u'application_gameinstance', 'links_game_time',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameInstance.motivation_game_time'
        db.delete_column(u'application_gameinstance', 'motivation_game_time')

        # Deleting field 'GameInstance.skill_game_time'
        db.delete_column(u'application_gameinstance', 'skill_game_time')

        # Deleting field 'GameInstance.links_game_time'
        db.delete_column(u'application_gameinstance', 'links_game_time')
    ...
    models = {
        ...
        u'application.gameinstance': {
            ...
            'cv_game_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'links_game_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'motivation_game_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'skill_game_time': ('django.db.models.fields.TimeField', [], {'null': 'True', 'blank': 'True'}),
