...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CvDocument.attachment'
        db.alter_column(u'application_cvdocument', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=10000000000000000000000000000000000000000000000000L))

    def backwards(self, orm):

        # Changing field 'CvDocument.attachment'
        db.alter_column(u'application_cvdocument', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=20000))

    models = {
        u'application.cvdocument': {
            'Meta': {'object_name': 'CvDocument'},
            'attachment': ('django.db.models.fields.files.FileField', [], {'max_length': '10000000000000000000000000000000000000000000000000L'}),
