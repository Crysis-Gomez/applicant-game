...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vacancy.pub_date'
        db.add_column(u'application_vacancy', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 6, 6, 0, 0)),
                      keep_default=False)


        # Changing field 'GameInstance.player_name'
        db.alter_column(u'application_gameinstance', 'player_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

    def backwards(self, orm):
        # Deleting field 'Vacancy.pub_date'
        db.delete_column(u'application_vacancy', 'pub_date')


        # Changing field 'GameInstance.player_name'
        db.alter_column(u'application_gameinstance', 'player_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
