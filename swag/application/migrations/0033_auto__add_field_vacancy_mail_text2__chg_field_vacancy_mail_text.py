...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'application_vacancy', 'mail_text2',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 6, 19, 0, 0), max_length=500),
                      keep_default=False)


        # Changing field 'Vacancy.mail_text'
        db.alter_column(u'application_vacancy', 'mail_text', self.gf('django.db.models.fields.TextField')(max_length=500))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Vacancy.mail_text'
        db.alter_column(u'application_vacancy', 'mail_text', self.gf('django.db.models.fields.CharField')(max_length=500))
