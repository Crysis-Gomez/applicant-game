...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GameInstance.player_motivation_uplockedQuest'
        db.delete_column(u'application_gameinstance', 'player_motivation_uplockedQuest')
    ...
    def backwards(self, orm):
        # Adding field 'GameInstance.player_motivation_uplockedQuest'
        db.add_column(u'application_gameinstance', 'player_motivation_uplockedQuest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
