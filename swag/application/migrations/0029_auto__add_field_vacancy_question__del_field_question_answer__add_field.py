...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vacancy.question'
        db.add_column(u'application_vacancy', 'question',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['application.Question'], null=True),
                      keep_default=False)

        # Removing M2M table for field questions on 'Vacancy'
        db.delete_table(db.shorten_name(u'application_vacancy_questions'))

        # Deleting field 'Question.answer'
        db.delete_column(u'application_question', 'answer')

        # Adding field 'PlayerQuestion.answer'
        db.add_column(u'application_playerquestion', 'answer',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vacancy.question'
        db.delete_column(u'application_vacancy', 'question_id')

        # Adding M2M table for field questions on 'Vacancy'
        m2m_table_name = db.shorten_name(u'application_vacancy_questions')
        ...
        # Deleting field 'PlayerQuestion.answer'
        db.delete_column(u'application_playerquestion', 'answer')
