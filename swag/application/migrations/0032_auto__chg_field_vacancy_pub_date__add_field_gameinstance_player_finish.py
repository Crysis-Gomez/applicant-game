...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vacancy.pub_date'
        db.alter_column(u'application_vacancy', 'pub_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
        # Adding field 'GameInstance.player_finished_intro'
        db.add_column(u'application_gameinstance', 'player_finished_intro',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Vacancy.pub_date'
        db.alter_column(u'application_vacancy', 'pub_date', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'GameInstance.player_finished_intro'
        db.delete_column(u'application_gameinstance', 'player_finished_intro')
