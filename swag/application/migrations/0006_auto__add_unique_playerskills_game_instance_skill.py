...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'PlayerSkills', fields ['game_instance', 'skill']
        db.create_unique(u'application_playerskills', ['game_instance_id', 'skill_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PlayerSkills', fields ['game_instance', 'skill']
        db.delete_unique(u'application_playerskills', ['game_instance_id', 'skill_id'])
