...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vacancy.job_description'
        db.delete_column(u'application_vacancy', 'job_description')

        # Adding field 'Vacancy.job_description_input'
        db.add_column(u'application_vacancy', 'job_description_input',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 7, 3, 0, 0), max_length=500),
                      keep_default=False)

        # Adding field 'Vacancy.job_description_output'
        db.add_column(u'application_vacancy', 'job_description_output',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 7, 3, 0, 0), max_length=500),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Vacancy.job_description'
        db.add_column(u'application_vacancy', 'job_description',
                      self.gf('django.db.models.fields.TextField')(default=datetime.datetime(2013, 7, 3, 0, 0), max_length=500),
                      keep_default=False)

        # Deleting field 'Vacancy.job_description_input'
        db.delete_column(u'application_vacancy', 'job_description_input')

        # Deleting field 'Vacancy.job_description_output'
        db.delete_column(u'application_vacancy', 'job_description_output')
