...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Vacancy.questions'
        db.delete_column(u'application_vacancy', 'questions_id')
    ...
    def backwards(self, orm):
        # Adding field 'Vacancy.questions'
        db.add_column(u'application_vacancy', 'questions',
    ...
    models = {
        ...
        u'application.vacancy': {
            ...
            'questions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['application.Question']", 'null': 'True', 'symmetrical': 'False'}),
