...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GameInstance.has_cv'
        db.add_column(u'application_gameinstance', 'has_cv',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GameInstance.has_cv'
        db.delete_column(u'application_gameinstance', 'has_cv')
