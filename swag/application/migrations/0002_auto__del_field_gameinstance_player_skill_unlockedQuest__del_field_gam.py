...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GameInstance.player_skill_unlockedQuest'
        db.delete_column(u'application_gameinstance', 'player_skill_unlockedQuest')

        # Deleting field 'GameInstance.player_motivation_unlockedQuest'
        db.delete_column(u'application_gameinstance', 'player_motivation_unlockedQuest')

        # Deleting field 'GameInstance.player_cv_unlockedQuest'
        db.delete_column(u'application_gameinstance', 'player_cv_unlockedQuest')

        # Deleting field 'GameInstance.player_link_unlockedQuest'
        db.delete_column(u'application_gameinstance', 'player_link_unlockedQuest')

        # Adding field 'GameInstance.cv_building_unlocked'
        db.add_column(u'application_gameinstance', 'cv_building_unlocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GameInstance.motivation_building_unlocked'
        db.add_column(u'application_gameinstance', 'motivation_building_unlocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GameInstance.skills_building_unlocked'
        db.add_column(u'application_gameinstance', 'skills_building_unlocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GameInstance.links_building_unlocked'
        db.add_column(u'application_gameinstance', 'links_building_unlocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GameInstance.player_skill_unlockedQuest'
        db.add_column(u'application_gameinstance', 'player_skill_unlockedQuest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GameInstance.player_motivation_unlockedQuest'
        db.add_column(u'application_gameinstance', 'player_motivation_unlockedQuest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GameInstance.player_cv_unlockedQuest'
        db.add_column(u'application_gameinstance', 'player_cv_unlockedQuest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'GameInstance.player_link_unlockedQuest'
        db.add_column(u'application_gameinstance', 'player_link_unlockedQuest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'GameInstance.cv_building_unlocked'
        db.delete_column(u'application_gameinstance', 'cv_building_unlocked')

        # Deleting field 'GameInstance.motivation_building_unlocked'
        db.delete_column(u'application_gameinstance', 'motivation_building_unlocked')

        # Deleting field 'GameInstance.skills_building_unlocked'
        db.delete_column(u'application_gameinstance', 'skills_building_unlocked')

        # Deleting field 'GameInstance.links_building_unlocked'
        db.delete_column(u'application_gameinstance', 'links_building_unlocked')
