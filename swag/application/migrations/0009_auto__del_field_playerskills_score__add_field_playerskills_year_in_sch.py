...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlayerSkills.year_in_school'
        db.add_column(u'application_playerskills', 'year_in_school',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PlayerSkills.year_in_school'
        db.delete_column(u'application_playerskills', 'year_in_school')
