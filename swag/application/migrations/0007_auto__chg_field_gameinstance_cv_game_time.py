...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GameInstance.cv_game_time'
        db.alter_column(u'application_gameinstance', 'cv_game_time', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'GameInstance.cv_game_time'
        db.alter_column(u'application_gameinstance', 'cv_game_time', self.gf('django.db.models.fields.DateTimeField')(null=True))
