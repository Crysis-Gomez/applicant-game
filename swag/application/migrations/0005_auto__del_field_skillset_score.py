...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SkillSet.score'
        db.delete_column(u'application_skillset', 'score')


    def backwards(self, orm):
        # Adding field 'SkillSet.score'
        db.add_column(u'application_skillset', 'score',
